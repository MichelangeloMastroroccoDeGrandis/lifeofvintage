    ...
    <div id="services" className={styles.services}>
        ...
        <div className={styles.container}>
            <motion.div id="aziende" initial={{ opacity: 0, y: 200 }} whileInView={{ opacity: 1, y: 0 }} transition={{duration: 2}} viewport={{ once: true }}>
                ...
                <h2 className={styles.serviceListTitle}>Per i Brand</h2>
                <ul className={styles.serviceList}>
                    ...
                    <li><p>Catalogazione, archiviazione e digitalizzazione archivi aziendali (in preparazione)</p></li>
            ...
            <motion.div id="retail" initial={{ opacity: 0, y: 200 }} whileInView={{ opacity: 1, y: 0 }} transition={{duration: 2}} viewport={{ once: true }}>
                ...
                <h2 className={styles.serviceListTitle}>Per i Retail</h2>
                <ul className={styles.serviceList}>
                    ...
                    <li><p>Collaborazione con lo store per incrementare la circolarità: recupero di abiti in disuso da loro clienti, trasformandoli in buoni acquisto da spendere presso la boutique stessa.</p></li>
                    
                </ul>
            </motion.div>
            <motion.div id="designer" initial={{ opacity: 0, y: 200 }} whileInView={{ opacity: 1, y: 0 }} transition={{duration: 2}} viewport={{ once: true }}>
               
                <h2 className={styles.serviceListTitle}>Per i Fashion Designer</h2>
                <ul className={styles.serviceList}>
                    ...
                    <li><p>Ricerca borse, cinture e accessoristica varia</p></li>
                    <li><p>Ricerca grafiche anni 1950/2000</p></li>
                    <li><p>Ricerca oggettistica vintage, americana e/o modernariato, mobili casa, atelier, show-room, spazi commerciali e uffici.</p></li>
